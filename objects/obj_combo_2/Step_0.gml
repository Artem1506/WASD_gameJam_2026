...
if (global.var_combo_p2 > prev_combo)
{
    ...
    if (global.var_combo_p2 > 1)
    {
        
        var combo_val = clamp(global.var_combo_p2, 0, 10);
    ...
    if (global.var_combo_p2 == 10)
    {
        reset_lag_active_timer = 3.0;
    }
}
prev_combo = global.var_combo_p2;
